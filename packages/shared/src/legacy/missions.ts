...
/**
 * A panicking survivor card for Mission 8's ascending mission zone — an otherwise ordinary suited card (playable
 * and discardable like any other), flagged `pilgrim` so placing it in the zone never buffs the current enemy's
 * attack the way pressing an ordinary party card into the same gap does (see GameState.ascendingZone).
 */
 ...
 * proprietary mission text. Currently Missions 1-6 and 8 of a longer arc: the party's early fights against a
 * corrupted syndicate, on through Mission 6's Garden of Remembrance and Mission 8's Heaven's Edge (Mission 7 is
 * still in progress elsewhere and isn't part of this list yet — the gap is intentional).
 */
