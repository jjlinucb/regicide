...
export interface Mission {
  ...
  /** See GameState.START_LEGACY_MISSION action's extraReserveCards. */
...
export const MISSIONS: Mission[] = [
  ...
  // Mission 8 is being built in a parallel session and isn't merged yet — when it lands, slot it in here (by id
  // order) rather than after Mission 9.
  {
    id: 9,
