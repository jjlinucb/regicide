 ...
 * player-chosen pick, the same shape as Missions 5/6/7's Reaver/Guardian/Druid stickers. `eligible` is already
 * filtered to chanterStickerEligible cards (rank 2, any base class except Bard, no existing special class or
 * sticker) by CampaignLobbyPage. Disappears once resolved (a party card now carries secondClassChanter).
 */
export function ChanterStickerPicker({
  eligible,
  isHost,
  onChoose,
}: {
