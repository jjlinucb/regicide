...
export function CampaignLobbyPage({
  ...
  // Mission 8's reward: same player-choice shape again, for rank-2 non-Bard cards and secondClassChanter.
  ...
  return (
    <div className="centered-page">
      ...
      <div className="panel legacy-panel">
        ...
        {chanterStickerGranted && !chanterStickerUsed && chanterStickerEligibleCards.length > 0 && (
